  ...
  return (
    <div className="text-white px-4">
     <div className="d-flex justify-content-center flex-column">
      ...
      <h3 style={{fontSize: "2rem"}} className="mt-5">თბილისის დრო</h3>
      <h1 style={{fontWeight: "600", fontSize: "2rem"}}>{time}</h1>
      <h2 style={{fontWeight: "600", fontSize: "2rem"}}>დღის მონაკვეთი: {partOfTheDay}</h2>
     </div>
    </div>
  )
}
