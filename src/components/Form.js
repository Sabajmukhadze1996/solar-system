...
function preventDefault(e) {
 return e.preventDefault()
  ...
  return (
<React.Fragment>
  <div className="planet-logo d-flex align-items-center flex-column">
     <IoMdPlanet size={140} className="navbar-brand" color="orange"/>
     <h1 style={{color: "white", fontSize: "2.4rem", fontWeight: "600", letterSpacing: "2px"}}>
      გაიგე მეტი მზის სისტემის შესახებ...
     </h1>
  </div>
<div className="app-parent" style={{maxWidth: "30rem", margin: "3rem auto"}}>
<div className="form" onChange={preventDefault}>
<h3 style={{fontSize: "2.4rem", color: "#285a9b"}} className="text-center fw-bold title-register">
   რეგისტრაცია
</h3>
 <Clock color="#285a9b" fontWeight="bold" textAlign="center" />
<hr />
<div className="form-floating mb-3">
  ...
  />
  <label htmlFor="floatingInput">სახელი...</label>
</div>
...
: null}
{errorText ? 
  <h1 style={{textAlign: "center", fontSize: "1.4rem", marginTop: "2rem", fontWeight: "700", color: "#f00000"}}>
